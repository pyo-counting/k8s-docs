...
- k8s는 no의 heartbeat, control plane 구성 요소의 leader election, kube-apiserver의 신원 제공을 위해 lease 개념을 사용한다. lease는 k8s resource로 제공되기 때문에 사용자 workload에서도 사용ㅎㄹ 수 있다. ([Leases](https://kubernetes.io/docs/concepts/architecture/leases/))
---
