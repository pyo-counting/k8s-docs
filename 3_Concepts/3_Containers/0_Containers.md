...
k8s는 containerd, CRI-O와 같이 [Kubernetes CRI(Container Runtime Interface)](https://github.com/kubernetes/community/blob/master/contributors/devel/sig-node/container-runtime-interface.md) 구현한 container runtime을 지원한다.
